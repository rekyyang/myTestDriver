...
func New(hdr *types.Header, view blocktree.View) (*StateDB, error) {
	sdb := &StateDB{
		prestates:            NewPreState(view),
		originalRoot:         hdr.Root,
...
func (db *StateDB) GetPrestateRLPEncode() ([]byte, error) {
	data, err := rlp.EncodeToBytes(db.prestates)
	return data, err
}

func (db *StateDB) CanUploadPrestates() bool {
	return db.prestates.allowUpload && db.prestates.accountPrestateMapChange
}

func (db *StateDB) EnableAllowUpload() {
	db.prestates.allowUpload = true
}

func (db *StateDB) DisableAllowUpload() {
	db.prestates.allowUpload = false
}

func (db *StateDB) GetAllowUpload() bool {
	return db.prestates.allowUpload
}

func (db *StateDB) SetPrestate(prestate *Prestates) {
	accountPrestateMap := make(map[common.Address]AccountPrestate)
	for addr, accountPrestate := range prestate.accountPrestateMap {
		...
		accountPrestateMap[addr] = tmpAccountPrestate
	}
	//tmp.allowUpload = true
	db.prestates.accountPrestateMap = accountPrestateMap
	//db.prestates.accountPrestateMap = prestate.accountPrestateMap
}
...
func (s *StateDB) getDeletedStateObject(addr common.Address) *StateObject {
	...
	//if acc, err = db.view.Account(addr); err != nil {
	if acc, err = s.prestates.Account(addr); err != nil {
...
func (s *StateDB) createObject(addr common.Address) (newobj, prev *StateObject) {
	...
	newobj = newObject(s, addr, models.Account{})
	if prev == nil {
...
func (s *StateDB) Copy() *StateDB {
	...
	state.prestates = s.prestates.Copy()
...
func (s *StateDB) IsArchive() bool {
	return s.prestates.IsArchive()
}
